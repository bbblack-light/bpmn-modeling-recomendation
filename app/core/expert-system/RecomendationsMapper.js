    ...
    static #expertSystemNormilizeRecomendations = [
        ...
        new RecomendationsSet(
            ...
            [
                new NormilizeRecomendation(status.HIGHT,
                    0.8, 1, 
                    "Настоятельно предлагаем оставить процесс в текущем состоянии. В угоду срокам поставки бизнеса процесса можно жертвовать качеством, но помните, что поддержание качества разрабатываемого ПО помогает избежать лишних трат на его поддержку и развитие"
                ),
                new NormilizeRecomendation(status.MEDIUM,
                    0.5, 0.8, 
                    "Предлагаем оставить процесс в текущем состоянии. Но если есть возможность поправить недостатки процесса, то предлагаем некоторые из них исправить на данном этапе, потому что поддержание качества разрабатываемого ПО помогает избежать лишних трат на его поддержку и развитие"
                )
            ]
        )
    ]
