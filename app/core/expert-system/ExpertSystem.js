...
const { outCodes, inputCodes } = require('../../domain/consts')
    ...
    static content = [
        new OutputNode(
            ...
            [
                ...
                new InputNode(inputCodes.CUSTOM_TASKLIST, 0.4),
                new InputNode(inputCodes.NOT_QUICK_RELEASE, 0.2),
                new InputNode(inputCodes.QUICK_RELEASE, -0.8),
        ...
        new OutputNode(
            ...
            [
                new InputNode(inputCodes.HANDLE_ERROR, 0.4),
        ...
        new OutputNode(
            ...
            [
                ...
                new InputNode(inputCodes.REPEATABLE_MOMENTS, 0.8),
                new InputNode(inputCodes.NOT_QUICK_RELEASE, 0.2),
                new InputNode(inputCodes.QUICK_RELEASE, -0.8),
            ]
        ),
        ...
        new OutputNode(
            ...
            [
                ...
                new InputNode(inputCodes.NO_CUSTOM_TASKLIST, 0.2),
